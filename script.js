...
function tooglePlay() {
    ...
    if(video.paused) {// ydi pause hai to play kar do aur pause icon ko play icon me badal do , fa pause ka sign || hota hai
        video.play();
...
function toggleFullscreen() {
  ...
  fullscreen = !fullscreen;// start me full screen nhi hai
}
